...
```
curl -fsSL "https://vibeboyrunner.github.io/vibeboyrunner/setups/v0.0.16/setup.sh" | bash -s install
```
...
The user is now inside the Vibeboyrunner environment. Tell them to:
